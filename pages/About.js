      ...
      <Layout darkMode={darkMode} setDarkMode={setDarkMode}>
         <section className="flex flex-col md:flex-row -my-28 mb-5">
            <div className="text-emerald-700 font-titleFont2 px-4 md:px-16 py-6 md:py-12 dark:text-red-50 md:w-1/2 md:pr-8">
               ...
               <p className="sm:text-xs lg:text-xl mt-4 md:mt-6 md:mb-40">
